...
<div class="col-12" id="isLoading" class="login-sec padding-top-30 padding-bottom-100 section">
            ...
            <div class="col-md-5">
                ...
                <div class="card" id="signin_form">
                    ...
                    <div class="card-body" style="position: relative;">
                        ...
                        <br>
                        <a href="{{ route('register') }}" style="cursor: pointer;color: green;">Create a account</a>
                        <a href="{{ route('forgotpassword') }}" style="cursor: pointer;float: right;">Forgot Passowrd</a>
                        <!--<user-login url="{{ Redirect::intended()->getTargetUrl() }}"
                        ></user-login>-->
                    </div>
                </div>
