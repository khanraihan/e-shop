...
Route::post('/logind', 'Auth\LoginController@login')->name('logind');

Route::get('/forgotpassword', 'Auth\ForgotPasswordController@forgotpassword')->name('forgotpassword');
Route::post('/checkuser', 'Auth\ForgotPasswordController@checkuser')->name('user_check');
Route::get('/changepass', 'Auth\ForgotPasswordController@chanpass')->name('passwordchange');
Route::post('/changepass', 'Auth\ForgotPasswordController@changepassword')->name('changepass');
// Ajax
...
Route::group(['prefix' => 'admin-ctp'], function(){
